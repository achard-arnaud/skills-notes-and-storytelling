...
## Contrat de rendu v0.2

Fixture de payload : `templates/strategic-fund-transformation/payload.example.json`.
Le schéma impose les cinq à sept pages et la provenance des figures ; les trois
processus figurent dans l'exemple Hivest. La fixture est volontairement sans
statistiques ni faits internes. Un cas de revenu GP testé séparément d'une valeur
LP positive est conservé ci-dessus. La promotion du template reste soumise à
revue humaine et aux contrôles de rendu.
