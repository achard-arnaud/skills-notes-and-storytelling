...
Representative case: governed agent runtime proposed to an event-driven platform team as an acceleration layer.

Checks:
- target account/platform truth built independently;
...
- material dependency/lock-in points identify control layer, process habit and exit path;
- counter-perspective challenges the fit thesis against no-action/internal-build/strongest alternative and one hidden veto or ownership conflict;
...
- dreaming tier selection runs after the opportunity decision.
