...
2. Current product and business truth.
3. Market shift and competitive threat.
4. Adjacency trajectory benchmark.
5. Business-model benchmark.
6. ICP / anti-ICP and why-now signals.
...
- extension toward the target category;
- economic buyer or budget already controlled;
- coexistence zone;
