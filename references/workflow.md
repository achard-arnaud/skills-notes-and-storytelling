...
4. decide one of:
   ...
   - `PIVOT_REQUIRED`;
   - `REOPEN_TARGETED`;
5. change the output only when the finding is decision-relevant.
...
7. stylistic/layout/render QA when applicable;
8. reader/decision QA;
9. decision + falsifier check;
10. bridge evaluation using preserved RunContext;
11. select dreaming tier using [dreaming-self-healing.md](dreaming-self-healing.md);
12. mandatory dreaming check;
13. if reusable delta exists, create candidate patch/fixture proposal for human approval.
